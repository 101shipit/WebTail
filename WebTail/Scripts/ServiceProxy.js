...
this.ServiceProxy = function (serviceUrl, options) {
    ...
    $.extend(i, typeof (serviceUrl) === "object" ? serviceUrl : options);
    ...
    this.invoke = function (method, params, callback, errorHandler) {
        ...
        var jsonData = i.isWcf ? JSON.stringifyWcf(params) : JSON.stringify(params);

        // Service endpoint URL        
        var url = i.serviceUrl + method;
